# ====================================================================================
# Setup Project
PROJECT_NAME := crossplane-provider-playground
PROJECT_REPO := github.com/ThinkportRepo/$(PROJECT_NAME)
...
XPKGS = provider-xacinfoblox
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-xacinfoblox: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider xacinfoblox CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider xacinfoblox controllers
...
# This target prepares repo for your provider by replacing all "xacinfoblox"
