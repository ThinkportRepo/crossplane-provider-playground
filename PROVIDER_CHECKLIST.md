...
The [provider-xacinfoblox](https://github.com/crossplane/provider-xacinfoblox) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-xacinfoblox](https://github.com/crossplane-contrib/provider-jet-xacinfoblox) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/ThinkportRepo/crossplane-provider-playground/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/ThinkportRepo/crossplane-provider-playground/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/ThinkportRepo/crossplane-provider-playground/blob/main/hack/boilerplate.go.txt](https://github.com/ThinkportRepo/crossplane-provider-playground/blob/main/hack/boilerplate.go.txt)
...
The [provider-xacinfoblox](https://github.com/crossplane/provider-xacinfoblox)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/ThinkportRepo/crossplane-provider-playground/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/ThinkportRepo/crossplane-provider-playground/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue xacinfobloxs (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/ThinkportRepo/crossplane-provider-playground/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request xacinfobloxs: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/ThinkportRepo/crossplane-provider-playground/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
